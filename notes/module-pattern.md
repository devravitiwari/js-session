...
## To understand the module pattern, we need to have understanding of functions as first-class citizens, scope rules, and closures.


### Using closures to achieve composibility

Getters and Setters

```js 
var module = (function(){
    var secretVariable = 0;
    return {
        getter : function(){
...
console.log(module.getter());
console.log(module.setter(4));
console.log(module.getter());

``` 
The above usage gives rise to what we call the module pattern

Here is an example of the shopping cart
